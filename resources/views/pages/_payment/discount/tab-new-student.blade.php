...
<script>
    ...
    const _discountReceiverNewStudentTable = {
        ...
        init: function(searchFilter = '#ALL') {
            dt = this.instance = $('#discount-new-student-table').DataTable({
                serverSide: true,
                ajax: {
                ...
                initComplete: function() {
                    $('.invoice-component-new-student-actions').html(`
                        <div style="margin-bottom: 7px">
                            <button onclick="_discountReceiverNewStudentTableActions.add()" class="btn btn-primary">
                    ...
                    $('.search-filter').html(`
                        <div id="discount-new-student-table_filter" class="dataTables_filter">
                            <label>
                                <input type="search" class="form-control" placeholder="Cari Data" aria-controls="discount-new-student-table" onkeyup="searchFilter(event, this)">
                            </label>
                        </div>
                    `);
                    feather.replace()
                ...
                return `
                    <div class="dropdown d-flex justify-content-center">
                        ...
                        <div class="dropdown-menu">
                            <a onclick="_discountReceiverNewStudentTableActions.edit(this)" class="dropdown-item" href="javascript:void(0);"><i data-feather="edit"></i>&nbsp;&nbsp;Edit</a>
