                ...
                config: {
                    ...
                    fields: {
                        ...
                        ms_type: {
                            ...
                            content: {
                                template:
                                    `<select name="ms_type" id="ms_type" class="form-control select2">
                        ...
                        md_period_start: {
                            ...
                            content: {
                                template:
                                    `<select name="ms_period_start" id="ms_period_start" class="form-control select2">
                        ...
                        md_period_end: {
                            ...
                            content: {
                                template:
                                    `<select name="ms_period_end" id="ms_period_end" class="form-control select2">
                                        <option value="">Pilih Periode</option>
                                    </select>`,
                            },
                        },
                        md_nominal: {
                            ...
                            content: {
                                template:
                                    `<input type="number" name="ms_nominal" class="form-control">`,
                            },
                        },
                        md_budget: {
                            ...
                            content: {
                                template:
                                    `<input type="number" name="ms_budget" class="form-control">`,
                            },
                        },
                        md_status: {
                            ...
                            content: {
                                template:
                                    `<br><input type="radio" name="ms_status" value="1" class="form-check-input" checked/> Aktif <input type="radio" name="ms_status" value="0" class="form-check-input"/> Tidak Aktif`,
                            },
                        },
                    },
                ...
                config: {
                    ...
                    fields: {
                        ...
                        md_status: {
                            ...
                            content: {
                                template:
                                    `<br><input type="radio" name="ms_status" value="1" id="ms_status_1" class="form-check-input" checked/> Aktif <input type="radio" name="ms_status" id="ms_status_0" value="0" class="form-check-input"/> Tidak Aktif`,
                            },
                        },
                    },
