...
@section('page_title', 'Pengaturan Tarif Tagihan Lainnya')
...
@include('pages._payment.settings._shortcuts', ['active' => 'other-rates'])
...
<script>
    ...
    $(function() {
        ...
        tables.columns([5,6]).visible(false);
    })
        ...
        init: function() {
            this.instance = $('#registration-form-table').DataTable({
                ...
                dom: '<"d-flex justify-content-between align-items-end header-actions mx-0 row"' +
                    '<"col-sm-12 col-lg-auto d-flex justify-content-center justify-content-lg-start" <"other-rates-actions d-flex align-items-end">>' +
                ...
                initComplete: function() {
                    $('.other-rates-actions').html(`
                        <div style="margin-bottom: 7px">
                            <button onclick="_registrationFormTableActions.add()" class="btn btn-info me-1">
                                <span style="vertical-align: middle">
                                    <i data-feather="plus" style="width: 18px; height: 18px;"></i>&nbsp;&nbsp;
                                    Tambah Tarif Lainnya
                                </span>
                            </button>
                        </div>
                    `)
                ...
                return `
                    <div class="dropdown d-flex justify-content-center">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a onclick="_registrationFormTableActions.delete(${id})" class="dropdown-item" href="javascript:void(0);"><i data-feather="trash"></i>&nbsp;&nbsp;Delete</a>
                        </div>
                    </div>
                `
            }
    ...
    const _registrationFormTableActions = {
        ...
        add: function() {
            Modal.show({
                type: 'form',
                modalTitle: 'Tambah Tarif Lainnya',
                config: {
