...
<div class="eazy-shortcut mb-3">
    <a
        href="{{ url('payment/report/old-student-receivables?').$arr_helper::query(['type' => 'study-program']) }}"
    ...
    <a
        href="{{ url('payment/report/old-student-receivables?').$arr_helper::query(['type' => 'student']) }}"
