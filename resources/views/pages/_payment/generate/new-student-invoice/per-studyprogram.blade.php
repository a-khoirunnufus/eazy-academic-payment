...
<button onclick="window.history.back()" class="btn btn-link" style="margin-bottom: 2rem">
    <i data-feather="arrow-left"></i>&nbsp;&nbsp;Kembali ke Tagihan Setiap Fakultas
</button>
    ...
    <table id="new-student-invoice-table" class="table table-striped">
        <thead>
            <tr>
                ...
                <th rowspan="2">Tipe Perkuliahan</th>
...
<script>
    ...
    const _newStudentInvoiceTable = {
        ...
        init: function() {
            this.instance = $('#new-student-invoice-table').DataTable({
                serverSide: true,
                ajax: {
                    url: _baseURL+'/api/payment/generate/new-student-invoice/get-studyprograms-lecture-types',
                    data: function(d) {
                ...
                initComplete: function() {
                    $('.new-student-invoice-actions').html(`
                        <div style="margin-bottom: 7px">
                            <h5>Tagihan Setiap Program Studi</h5>
                        </div>
                    `)
                    feather.replace()
                }
                ...
                return `
                    <div class="dropdown d-flex justify-content-center">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a onclick="_newStudentInvoiceTableActions.openStudents(event)" class="dropdown-item"><i data-feather="external-link"></i>&nbsp;&nbsp;Lihat Mahasiswa</a>
    ...
    const _newStudentInvoiceTableActions = {
        ...
        detail: async function(e) {
            ...
            const studentCount = await $.ajax({
                ...
                data: {
                    ...
                    studyprogram_lecture_type_id: data.mma_lt_id,
                }
            });
        ...
        openStudents: function(e) {
            const studyprogramLectureTypeId = _newStudentInvoiceTable.getRowData(e.currentTarget).mma_lt_id;
            window.location.href = `${_baseURL}/payment/generate/new-student-invoice/per-student?period_path_id=${periodPathId}&faculty_id=${facultyId}&studyprogram_lecture_type_id=${studyprogramLectureTypeId}`;
        },
        generate: function() {
            Swal.fire({
                title: 'Konfirmasi',
