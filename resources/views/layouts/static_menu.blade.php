        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item mb-50">
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu__item nav-item {{ 'generate/old-student-invoice' == request()->path() ? 'active' : '' }}">
                        <a class="d-flex align-items-center fw-bold" href="{{ url('generate/old-student-invoice') }}">
                            <i data-feather="circle"></i>
