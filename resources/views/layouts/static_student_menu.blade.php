<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow @yield('sidebar-size')" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item mb-50 {{ 'student.invoice.index' == request()->route()->getName() ? 'active' : '' }}">
                <a class="d-flex align-items-center fw-bold" href="{{ route('student.invoice.index') }}">
                    <i data-feather="file-text"></i>
                    <span class="menu-title text-truncate">Tagihan</span>
                </a>
            </li>
            <li class="nav-item mb-50 {{ 'student.balance.index' == request()->route()->getName() ? 'active' : '' }}">
                <a class="d-flex align-items-center fw-bold" href="{{ route('student.balance.index') }}">
                    <i data-feather="file-text"></i>
