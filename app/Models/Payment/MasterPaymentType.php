...
use App\Models\Payment\MasterPaymentAdminCost;

class MasterPaymentType extends Model
{
    use SoftDeletes;

    protected $table = "finance.ms_payment_type";
    ...
    {
        return $this->hasMany(MasterPaymentAdminCost::class, 'payment_type_code', 'code');
    }
