...
class NewStudent implements INewStudent {
    ...
    public function __construct()
    {
        $query = DB::table('pmb.participant as p')
            ...
            // ->leftJoin('masterdata.ms_period as period', 'period.period_id', '=', 'r.ms_period_id') // masterdata is outdated
            // ->leftJoin('masterdata.ms_path as path', 'path.path_id', '=', 'r.ms_path_id') // masterdata is outdated
